...
INSERT INTO "new_Task" ("areaId", "createdAt", "deleted", "globalOrder", "headingId", "id", "notes", "projectId", "title", "updatedAt", "userId", "when", "whenDate") SELECT "areaId", "createdAt", "deleted", "globalOrder", "headingId", "id", "notes", "projectId", "title", "updatedAt", "userId", "when", "whenDate" FROM "Task";
DROP TABLE "Task";
