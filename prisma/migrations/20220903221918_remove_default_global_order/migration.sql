...
INSERT INTO "new_Project" ("areaId", "createdAt", "deleted", "done", "globalOrder", "id", "notes", "title", "updatedAt", "userId", "when", "whenDate") SELECT "areaId", "createdAt", "deleted", "done", "globalOrder", "id", "notes", "title", "updatedAt", "userId", "when", "whenDate" FROM "Project";
DROP TABLE "Project";
...
INSERT INTO "new_Task" ("areaId", "createdAt", "deleted", "done", "globalOrder", "headingId", "id", "notes", "projectId", "title", "updatedAt", "userId", "when", "whenDate") SELECT "areaId", "createdAt", "deleted", "done", "globalOrder", "headingId", "id", "notes", "projectId", "title", "updatedAt", "userId", "when", "whenDate" FROM "Task";
DROP TABLE "Task";
...
INSERT INTO "new_Heading" ("archived", "createdAt", "globalOrder", "id", "projectId", "title", "updatedAt", "userId") SELECT "archived", "createdAt", "globalOrder", "id", "projectId", "title", "updatedAt", "userId" FROM "Heading";
DROP TABLE "Heading";
...
INSERT INTO "new_Area" ("createdAt", "deleted", "globalOrder", "id", "title", "updatedAt", "userId") SELECT "createdAt", "deleted", "globalOrder", "id", "title", "updatedAt", "userId" FROM "Area";
DROP TABLE "Area";
